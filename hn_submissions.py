...
Этот вызов API возвращает список идентификаторов 30 самых популярных статей на Hacker News на момент выдачи вызова.
"""
...
for submission_id in submission_ids[:30]:  # для перебора идентификаторов 30 самых популярных статей
